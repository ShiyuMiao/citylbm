...
- Generated: 2026-08-24T23:56:52.153797Z
- Case preset: casea
...
### F:\Grade2master2\CITYLBM开发文件\v0.2.1\validation_runs\casea_native_preflight_current_strict_20260825_bound_metadata_refresh
- Failures:
  ...
  - inlet_reynolds_stress_evidence.json:paper_grade_gate:fail:measured_tensor (stress_csv_no_valid_full_tensor_rows; measured_stress_tensor_requires_at_least_two_valid_heights)
  - inlet_reynolds_stress_evidence.json:gate:fail:measured_tensor (stress_csv_no_valid_full_tensor_rows; measured_stress_tensor_requires_at_least_two_valid_heights)
