...
def command_lines(suite: Dict[str, Any]) -> List[str]:
    display_commands = {
        ...
        "build_chain_audit": "python docs/experiments/casee/tools/build_chain_audit.py",
        "casee_official_run_preflight": "python docs/experiments/casee/tools/casee_official_run_preflight.py",
        "casee_dx1_readiness_audit": "python docs/experiments/casee/tools/casee_dx1_readiness_audit.py",
        ...
        "casee_zcenter_rerun_consistency": "python docs/experiments/casee/tools/casee_zcenter_rerun_consistency.py",
        "casee_c002_longer_mean_audit": "python docs/experiments/casee/tools/casee_c002_longer_mean_audit.py",
        "casee_c003_zorigin_ablation_audit": "python docs/experiments/casee/tools/casee_c003_zorigin_ablation_audit.py",
        "casee_c004_dx3_low_cost_audit": "python docs/experiments/casee/tools/casee_c004_dx3_low_cost_audit.py",
        "casee_c005_decomposition_audit": "python docs/experiments/casee/tools/casee_c005_decomposition_audit.py",
        "casee_c008_c009_inlet_turbulence_audit": "python docs/experiments/casee/tools/casee_c008_c009_inlet_turbulence_audit.py",
        "casee_candidate_sweep_plan": "python docs/experiments/casee/tools/casee_candidate_sweep_plan.py",
        ...
        "citylbm_manifest_schema_gate": "python docs/experiments/casee/tools/citylbm_manifest_schema_gate.py",
        "casee_manuscript_results_table": "python docs/experiments/casee/tools/casee_manuscript_results_table.py",
        "casee_manuscript_section_pack": "python docs/experiments/casee/tools/casee_manuscript_section_pack.py",
...
def main() -> int:
    ...
    payload = {
        ...
        "source_artifacts": [
            ...
            display_path(RESULTS_DIR / "casee_manuscript_section_pack.json"),
        ],
