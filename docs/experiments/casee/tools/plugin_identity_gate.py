...
RELEASE_NOTES = ROOT / "docs" / "releases" / "v0.4.0-rc34.md"
...
def main() -> int:
    ...
    checks = {
        ...
        "root_readme_mentions_rc34_release_notes": contains(README, "docs/releases/v0.4.0-rc34.md"),
        "citylbm_readme_mentions_rc_status": contains(CITYLBM_README, "CityLBM v0.4.0-rc Status"),
        "changelog_has_rc34": contains(CHANGELOG, "## v0.4.0-rc34"),
