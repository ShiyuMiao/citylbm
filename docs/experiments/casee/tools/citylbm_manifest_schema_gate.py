...
def build_checks() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        check_row(
            ...
            "Use to document wall/roughness follow-up controls as default-off traceability fields.",
            "Restore wall/roughness manifest fields and default-promotion blockers.",
        ),
        check_row(
