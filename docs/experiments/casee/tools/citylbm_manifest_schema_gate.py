...
def build_checks() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        check_row(
            ...
            FLUIDX,
            "diagnostic_boundary",
            "Use to keep diagnostic sampling, offsets, wall models, and roughness out of formal result claims.",
            "Restore diagnostic substitute blocking fields.",
        ),
        check_row(
            "wall_roughness_default_safe_fields_present",
            all_in(
                fluidx,
                [
            ...
            FLUIDX,
            "wall_roughness_boundary",
            "Use to document wall/roughness/inlet follow-up controls as default-off traceability fields.",
            "Restore wall/roughness/inlet manifest fields and default-promotion blockers.",
        ),
        check_row(
