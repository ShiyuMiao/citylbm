#!/usr/bin/env python3
"""Audit that the packaged CityLBM GHA contains the Case E Remediation Plan component."""
...
SOURCE_GATE = RESULTS_DIR / "citylbm_casee_remediation_plan_component_gate.json"
OUT_JSON = RESULTS_DIR / "citylbm_casee_remediation_plan_binary_gate.json"
OUT_CSV = RESULTS_DIR / "citylbm_casee_remediation_plan_binary_gate.csv"
OUT_MD = RESULTS_DIR / "citylbm_casee_remediation_plan_binary_gate.md"


REQUIRED_MARKERS = [
    "CaseERemediationPlanComponent",
    ...
    "Forbidden Claims",
    "Next Experiments",
    "B001 official_z2m_metric_gate",
    "B002 rhino_new_gha_load",
    "B003 gpu_runtime",
    "B004 vs_cpp_build_tools",
    "B005 dx1_high_resolution_run",
    "casee_audit.py --release-target v0.4.0",
    ...
    "casee_wall_model_followup",
    "casee_inlet_turbulence_followup",
    "casee_dx1_feasibility_or_run",
    "3F46B886-F94E-492D-9D4F-FA6F170BF1D2",
]
...
def build_payload() -> Dict[str, Any]:
    ...
    checks = {
        ...
        "source_component_gate_passed": source_gate.get("casee_remediation_plan_component_gate_passed") is True,
    ...
    return {
        ...
        "claim_readiness": "paper_ready_packaged_casee_remediation_plan_component" if passed else "blocked_packaged_casee_remediation_plan_component",
        "casee_remediation_plan_binary_gate_passed": passed,
        ...
        "checks": checks,
        "boundary": (
            "This gate checks that the packaged GHA contains the Case E Remediation Plan component strings. "
...
def write_markdown(path: Path, payload: Dict[str, Any]) -> None:
    lines = [
        ...
        "## Verdict",
        "",
        f"- Gate passed: {payload['casee_remediation_plan_binary_gate_passed']}",
...
def main() -> int:
    ...
    print(
        json.dumps(
            {
                "casee_remediation_plan_binary_gate_passed": payload["casee_remediation_plan_binary_gate_passed"],
                "out_json": rel(OUT_JSON),
            },
            indent=2,
        )
    )
    return 0 if payload["casee_remediation_plan_binary_gate_passed"] else 1
