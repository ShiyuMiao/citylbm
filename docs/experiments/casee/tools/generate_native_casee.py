...
def main() -> int:
    ...
    run_id = f"casee_native_dx{args.dx:g}_{wind_label}_{sgs_label}_{ground_label}_{zoff_label}_{nu_label}{domain_label}{inlet_label}{wall_label}_pmodes_steps{args.steps}_spin{args.spinup}"
