...
COMPONENT_GATE = ROOT / "docs/experiments/casee/results/citylbm_casee_official_residual_diagnostics_component_gate.json"
OUT_JSON = ROOT / "docs/experiments/casee/results/citylbm_casee_official_residual_diagnostics_binary_gate.json"
OUT_CSV = ROOT / "docs/experiments/casee/results/citylbm_casee_official_residual_diagnostics_binary_gate.csv"
OUT_MD = ROOT / "docs/experiments/casee/results/citylbm_casee_official_residual_diagnostics_binary_gate.md"


REQUIRED_MARKERS = [
    "CaseEOfficialResidualDiagnosticsComponent",
    "Case E Official Residual Diagnostics",
    "Top Residual Rows",
    "Group Rows",
    "Risk Rows",
    "Formal Diagnostic Ready",
    "Claim Readiness",
    ...
    "probe_id_check=",
    "9BAEAB1F-6F24-4679-B940-D4E97DE0D54B",
]
...
def main() -> int:
    ...
    checks = {
        ...
        "source_component_gate_passed": bool(component_gate_payload.get("casee_official_residual_diagnostics_component_gate_passed")),
    ...
    payload = {
        ...
        "claim_readiness": "paper_ready_packaged_casee_official_residual_diagnostics_component",
        "casee_official_residual_diagnostics_binary_gate_passed": passed,
        "formal_accuracy_claim_supported": False,
        "formal_release_allowed": False,
        ...
        "checks": checks,
        "boundary": (
            "This gate checks that the packaged GHA contains the Case E Official Residual Diagnostics "
            "component strings. It is packaging evidence for residual diagnostics only; it does not "
    ...
    OUT_MD.write_text(
        "# CityLBM Case E Official Residual Diagnostics Binary Gate\n\n"
        ...
        "- formal_release_allowed: false\n"
        "- default_setting_allowed: false\n"
        "- boundary: packaged residual-diagnostics evidence only; no CFD run or metric improvement.\n",
        encoding="utf-8",
    )
