...
RESULT_PATTERNS = [
    ...
    "citylbm_casee_postrun_audit_component_gate.*",
    ...
    "citylbm_casee_remediation_plan_component_gate.*",
    "citylbm_casee_remediation_plan_binary_gate.*",
    "citylbm_casee_official_metric_gate_component_gate.*",
    ...
    "casee_rhino_load_evidence_packet_gate.*",
    "rhino_gha_load_manifest.expected.json",
    ...
    "casee_research_accuracy_gap_gate.*",
    "casee_accuracy_action_plan_gate.*",
    "casee_default_policy_gate.*",
    "casee_default_promotion_gate.*",
    "casee_wall_followup_codegen_gate.*",
    "casee_inlet_followup_codegen_gate.*",
    "casee_c016_codegen_gate.*",
    "casee_native_codegen_smoke_gate.*",
    "casee_runbook_codegen_preflight.*",
...
TOOL_SCRIPTS = [
    ...
    "casee_research_accuracy_gap_gate.py",
    "casee_accuracy_action_plan_gate.py",
    ...
    "casee_workspace_hygiene_gate.py",
    ...
    "casee_default_promotion_gate.py",
    "casee_wall_followup_codegen_gate.py",
    "casee_inlet_followup_codegen_gate.py",
    "casee_c016_codegen_gate.py",
    "casee_native_codegen_smoke_gate.py",
    "casee_runbook_codegen_preflight.py",
    ...
    "citylbm_casee_remediation_plan_component_gate.py",
    "citylbm_casee_remediation_plan_binary_gate.py",
    "citylbm_casee_official_metric_gate_component_gate.py",
    ...
    "casee_rhino_load_evidence_packet_gate.py",
...
def claim_readiness(path: str, cat: str, inventory_row: Dict[str, str]) -> str:
    ...
    if "citylbm_casee_paper_claim_card" in path:
        return "paper_ready_software_feedback_boundary"
    if "citylbm_casee_remediation_plan" in path:
        return "blocked_followup_plan"
    if "citylbm_casee_official_metric_gate" in path:
