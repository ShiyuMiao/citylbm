#!/usr/bin/env python3
"""Audit that the packaged CityLBM GHA contains the Case E Paper Claim Card component."""
...
SOURCE_GATE = RESULTS_DIR / "citylbm_casee_paper_claim_card_component_gate.json"
OUT_JSON = RESULTS_DIR / "citylbm_casee_paper_claim_card_binary_gate.json"
OUT_CSV = RESULTS_DIR / "citylbm_casee_paper_claim_card_binary_gate.csv"
OUT_MD = RESULTS_DIR / "citylbm_casee_paper_claim_card_binary_gate.md"


REQUIRED_MARKERS = [
    "CaseEPaperClaimCardComponent",
    ...
    "BA36730E-EEE4-4DB6-A360-61F889517DF1",
]
...
def build_payload() -> Dict[str, Any]:
    ...
    checks = {
        ...
        "source_component_gate_passed": source_gate.get("casee_paper_claim_card_component_gate_passed") is True,
    ...
    return {
        ...
        "claim_readiness": "paper_ready_packaged_casee_paper_claim_card_component" if passed else "blocked_packaged_casee_paper_claim_card_component",
        "casee_paper_claim_card_binary_gate_passed": passed,
        ...
        "checks": checks,
        "boundary": (
            "This gate checks that the packaged GHA contains the Case E Paper Claim Card component strings. "
...
def write_markdown(path: Path, payload: Dict[str, Any]) -> None:
    lines = [
        ...
        "## Verdict",
        "",
        f"- Gate passed: {payload['casee_paper_claim_card_binary_gate_passed']}",
...
def main() -> int:
    ...
    print(
        json.dumps(
            {
                "casee_paper_claim_card_binary_gate_passed": payload["casee_paper_claim_card_binary_gate_passed"],
                "out_json": rel(OUT_JSON),
            },
            indent=2,
        )
    )
    return 0 if payload["casee_paper_claim_card_binary_gate_passed"] else 1
