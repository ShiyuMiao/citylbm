...
Generated: 2026-08-13T04:27:34.290193+00:00
...
- paper_ready_claim_support_gate; blocked formal accuracy release: 1
...
| Experiment 2 / AIJ Case E | `claim_support_gate` | paper_ready_claim_support_gate; blocked formal accuracy release | claim_support_gate_passed=True; claim_count=14; no_formal_accuracy_claims=True; forbidden_success_patterns_blocked=True | Use as a manuscript claim-triage table that separates method/protocol, negative validation, limitations-only diagnostics, and blocked release claims. |
...
| Experiment 2 / AIJ Case E | `claim_support_gate` | paper_ready_claim_support_gate; blocked formal accuracy release | Claim triage only; it does not add CFD output, improve official metrics, or permit formal v0.4.0. | Keep claim-support checks downstream of release_gate and solver provenance before paper drafting. |
