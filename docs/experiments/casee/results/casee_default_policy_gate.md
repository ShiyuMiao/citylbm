...
Generated: 2026-08-11T03:13:33.391255+00:00
...
| `simulation_settings_residual_target_default_off` | True | `CityLBM/src/Core/FluidX3DInterface.cs` | Residual-target follow-up metadata is default-off and cannot become a formal accuracy model without official z=2 m improvement. |
...
| `run_component_residual_target_inputs_default_off` | True | `CityLBM/src/Components/Simulation/RunSimulationComponent.cs` | Diagnostic residual-target mode and scale stay off unless explicitly set. |
...
| `manifest_blocks_wall_roughness_formal_defaults` | True | `CityLBM/src/Core/FluidX3DInterface.cs` | Run manifests forbid wall-model, roughness, inlet-turbulence, and residual-target diagnostics from becoming default accuracy claims. |
