...
| `CityLBM/bin/Release` | True | 4 | 3.933 |
| `CityLBM/obj` | True | 14 | 0.366 |
...
- Action: Free C: drive space to at least 8 GB before retrying VS Build Tools C++; current free space is 0.0 GB. Workspace build-cache candidates total only 4.299 MB.
