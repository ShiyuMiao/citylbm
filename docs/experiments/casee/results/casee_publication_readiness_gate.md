...
Generated: 2026-08-11T03:33:12.524827+00:00
...
| `PR010` | Are release assets lightweight and traceable? | paper_ready_release_assets | Data and code availability | The artifact index records 372 artifacts and 300 lightweight release assets; the curated release manifest selects 66 upload assets and keeps 20 raw/large assets excluded or hash-only. | Do not commit large VTK/raw geometry duplicates as manuscript evidence. |
