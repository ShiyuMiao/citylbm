...
Generated: 2026-08-13T06:08:52.903995+00:00
...
| `PR010` | Are release assets lightweight and traceable? | paper_ready_release_assets | Data and code availability | The artifact index records 407 artifacts and 334 lightweight release assets; the curated release manifest selects 86 upload assets and keeps 20 raw/large assets excluded or hash-only. | Do not commit large VTK/raw geometry duplicates as manuscript evidence. |
