...
Generated: 2026-08-11T01:31:26.792702+00:00
...
| `PR010` | Are release assets lightweight and traceable? | paper_ready_release_assets | Data and code availability | The artifact index records 316 artifacts and 244 lightweight release assets; the curated release manifest selects 63 upload assets and keeps 20 raw/large assets excluded or hash-only. | Do not commit large VTK/raw geometry duplicates as manuscript evidence. |
