...
Generated: 2026-08-11T00:47:33.592110+00:00
...
| `PR007` | Has the software feedback been constrained to validated defaults and diagnostic switches? | paper_ready_software_boundary | Software implications / Limitations | CityLBM converts evidence into formal defaults, diagnostic-only switches, and release blockers. | Do not promote benchmark-tuned diagnostics to default accuracy models. |
...
| `PR010` | Are release assets lightweight and traceable? | paper_ready_release_assets | Data and code availability | The artifact index records 298 artifacts and 226 lightweight release assets. | Do not commit large VTK/raw geometry duplicates as manuscript evidence. |
