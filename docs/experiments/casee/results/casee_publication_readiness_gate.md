...
Generated: 2026-08-13T10:24:11.186285+00:00
...
| `PR010` | Are release assets lightweight and traceable? | paper_ready_release_assets | Data and code availability | The artifact index records 441 artifacts and 368 lightweight release assets; the curated release manifest selects 113 upload assets and keeps 20 raw/large assets excluded or hash-only. | Do not commit large VTK/raw geometry duplicates as manuscript evidence. |
