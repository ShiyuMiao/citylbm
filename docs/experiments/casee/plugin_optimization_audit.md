...
- The manuscript claim matrix converts the Case E evidence package into `paper_ready`, `limitations_ready`, `weaken_claim`, and `blocked` claim classes. It supports manuscript preparation without upgrading diagnostic evidence into a formal accuracy claim.
