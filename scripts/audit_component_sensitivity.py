...
def source_window_summary(
    ...
    source_file_hash_cache: Dict[str, str] = {}
    ...
    for row in probe_rows:
        ...
        for raw_file in source_files:
            ...
            if source_file_key not in source_file_hash_cache:
                source_file_hash_cache[source_file_key] = sha256_file(source_file).lower()
            actual_hashes.append(source_file_hash_cache[source_file_key])
