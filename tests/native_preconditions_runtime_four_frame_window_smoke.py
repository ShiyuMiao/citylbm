...
def main() -> int:
    ...
    for expected in [
        ...
        "runtime_final_window_frame_count_gate_not_pass:fail",
        "runtime_final_window_frame_count_reason:runtime_average_window_frame_count_4_below_minimum_40",
        "runtime_final_window_frame_count_reason:runtime_source_frame_count_4_below_minimum_40",
        "runtime_final_window_frame_count_reason:runtime_source_vtk_sha256_count_4_below_minimum_40",
