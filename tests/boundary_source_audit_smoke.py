...
""",
        ...
        require(late_upload.get("development_acceleration_stage") == "fix_boundary_source_before_cfd", late_upload)
        require(late_upload.get("development_acceleration_runs_cfd_next") is False, late_upload)
...
""",
        ...
        require(advanced.get("development_acceleration_stage") == "implement_boundary_methods_before_cfd", advanced)
        require(advanced.get("development_acceleration_runs_cfd_next") is False, advanced)
...
""",
        ...
        require(unapplied.get("development_acceleration_stage") == "implement_boundary_methods_before_cfd", unapplied)
        require(unapplied.get("development_acceleration_runs_cfd_next") is False, unapplied)
...
""",
        ...
        require(advanced.get("long_cfd_allowed_by_boundary_source_audit") is True, advanced)
