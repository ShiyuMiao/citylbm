...
""",
        ...
        single_condition = root / "official_single_condition.csv"
        write_text(
            single_condition,
...
""",
        ...
        run_command(probe_args(vtk, single_condition, root / "single_condition.csv", "--case", "CaseA", "--wind-direction-label", "N"))
