...
- 新增的原生 FluidX3D Case A 300/150 诊断跑产生 2 个完整 VTK 帧，并完成 186 个官方测点的后处理审计。
...
- A fresh native FluidX3D Case A 300/150 diagnostic run produced 2 complete VTK frames and completed post-processing for 186 official probe points.
