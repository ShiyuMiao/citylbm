...
### "FluidX3D.exe not found" error
- On first run, the solver extracts to `%APPDATA%\CityLBM\`
- Ensure your antivirus doesn't block execution from this folder
- The embedded solver is pre-compiled — no C++ installation needed
