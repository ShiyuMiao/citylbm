...
This is a component-level statistical robustness analysis derived from S0 simulation outputs. It is not causal identification, field validation, annual comfort/safety compliance, pollutant dispersion, or proof of intervention optimization. The S1 ventilation-relief comparison is reported separately as a near-null/negative design-sensitivity result.
