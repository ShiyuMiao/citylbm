...
def main():
    ...
    claim_rows = [
        ...
        ["C8", "Pollutant dispersion, S1 design-intervention improvement, GCBTE, and formal comfort/safety exceedance remain unsupported.", "no scalar transport, no simulated S1, no 3DGS boundary extraction, no measured wind rose", "blocked", "design_scenario_manifest.csv; gcbte_status_table.csv; claim_boundary.md", "blocked"],
    ]
