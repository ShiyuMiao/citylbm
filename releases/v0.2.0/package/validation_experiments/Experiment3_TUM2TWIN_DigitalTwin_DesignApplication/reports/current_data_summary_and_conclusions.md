...
| Evidence inventory | `manifests/evidence_inventory.csv` | 85 rows | newly_run + preexisting_artifact + user_claim + blocked | Maps claims to evidence type and source artifact |
