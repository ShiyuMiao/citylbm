...
Audit result: the current manifest contains 511 archived files, 0 missing
...
Audit result: the final archive currently contains 24 key result rows, 12
reviewer-facing figure/table callouts, 12 ready submission assets, and 133
